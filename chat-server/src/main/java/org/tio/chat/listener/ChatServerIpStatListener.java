 ...
 *
 */
public class ChatServerIpStatListener implements IpStatListener {
    @SuppressWarnings("unused")
    private static Logger log = LoggerFactory.getLogger(ChatServerIpStatListener.class);
    public static final ChatServerIpStatListener me = new ChatServerIpStatListener();
    /**
     *
     */
    private ChatServerIpStatListener() {
    }
    @Override
